// TODO this command should if needed setup/clone the frontend-components repository
// TODO there should be a sub command if an app is given and install/link the packages with that app
// Example:
